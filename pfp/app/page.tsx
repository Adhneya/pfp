...
export default function Page() {
  return (
    <main>
      ...
      {/* Services (placeholder section to match nav) */}
      <section id="services" className="mx-auto max-w-5xl px-4 py-16" style={{ scrollMarginTop: "4.5rem" }}>
        <h2 className="text-2xl font-semibold md:text-3xl">Services</h2>
        <p className="mt-2 max-w-2xl text-foreground/70">
          I offer end-to-end web development, from design systems to API development and deployment.
        </p>
      ...
      {/* About (placeholder section to match nav) */}
      <section id="about" className="mx-auto max-w-5xl px-4 py-16" style={{ scrollMarginTop: "4.5rem" }}>
        <h2 className="text-2xl font-semibold md:text-3xl">About</h2>
        <p className="mt-2 max-w-2xl text-foreground/70">
          I’m a developer focused on building delightful user experiences with a strong foundation in engineering best
          practices.
        </p>
      </section>

      {/* Portfolio (placeholder with images) */}
      <section id="portfolio" className="mx-auto max-w-5xl px-4 py-16" style={{ scrollMarginTop: "4.5rem" }}>
